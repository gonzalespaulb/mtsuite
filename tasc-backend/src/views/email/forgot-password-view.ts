const resetPasswordView = (code: string, url: string, validLength: string) => `
...
>
  <head>
    ...
    <style type="text/css">
      ...
      .welcomeSubheading {
      font-size: 14px; line-height: 14px; color: #0C3B6F; font-weight: 400;
      }
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <!------------------------------------ START OF CONTENT------------------------------------>
                                        ...
                                        >
                                            <span class="welcomeHeading">
                                                Forgot Password
                                            </span>
                                        </div>
                                        <div style="width: 100%; text-align: center;">
                                            <span class="welcomeSubheading">
                                                Please follow the instructions below to get started.
                                            </span>
                                        </div>

                                        <div style="width: 100%; margin-top: 32px; text-align: center;">
                                            <span class="instruction">1. COPY AND PASTE<span>
                                        </div>

                                        <div style="width: 100%; margin-top: 8px; text-align: center;">
                                            <span class="note">This code is available for ${validLength} only.<span>
                                        </div>

                                        <div style="width: 100%; margin-top: 8px; text-align: center;">
                                            <span class="linkStyle">${code}<span>
                                        </div>

                                        <div style="width: 100%; margin-top: 32px; text-align: center;">
                                            <span class="instruction">2. FOLLOW THIS RESET LINK<span>
                                        </div>

                                        <div style="width: 100%; margin-top: 16px; text-align: center;">
                                            <a href="${url}" target="_blank">
                                            <span class="linkStyle">Reset my password<span>
                                            </a>
                                        </div>
                                        <!------------------------------------ END OF CONTENT------------------------------------>
                                      </td>
