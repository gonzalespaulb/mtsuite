const deleteScheduleView = (date: string, designation: string, location: string, startTime: string): string => `
                                      ...
                                      <!------------------------------------ START OF CONTENT------------------------------------>
                                        ...
                                        >
                                            <span class="scheduleDate">
                                                You have been removed from the schedule for ${date}.
                                            </span>
                                        </div>
...
export default deleteScheduleView;
