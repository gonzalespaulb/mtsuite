                                      ...
                                      <!------------------------------------ START OF CONTENT------------------------------------>
                                        ...
                                        >
                                            <span class="scheduleDate">
                                                Email failed to send to ${email}.
                                            </span>
                                        </div>

                                        <div style="width: 100%; margin-top: 32px; text-align: center;">
                                            <span class="instruction">Schedule Title<span>
                                        </div>

                                        <div style="width: 100%; margin-top: 16px; text-align: center;">
                                            <span class="infoStyle">| ${scheduleTitle} |<span>
                                        </div>

                                        <div style="width: 100%; margin-top: 32px; text-align: center;">
                                            <span class="instruction">Schedule Date<span>
                                        </div>

                                        <div style="width: 100%; margin-top: 16px; text-align: center;">

                                            <span class="infoStyle">| ${scheduleDate} |<span>
...
export default failSentScheduleView;
